...
from modules.basic import click_change,log_write,adb_test,img_recognition,ocr_recognition,shot_tap,move_to

shot=shot_tap()
irec=img_recognition(package_name=__name__)
orec=ocr_recognition(package_name=__name__)
print(__name__)

class relic_rec(dict):
    ...
    def division_recognize(self,):
        ...
        orec.result('./imgs/p2.png')
        irec.get_xy('unlocked',img_path='./imgs/p2.png')
